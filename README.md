...
Action required for Students
[Google Form] CSE221 Lab Policy:
- The lab policy file can be found here - Link
- Please complete the lab policy acknowledgement form - Link
[Google Form] Codeforces Account Information: (Action required)
- Open an account at https://codeforces.com/
- Please submit your codeforces details here - Link

Necessary Resources [Bookmark the Link]
Student Drive Folder: Link
The folder contains:
- Lab Policy
- Sample Quiz Checkers
- Environment Setup for Quiz Checker
- Previous Semesters’ Lab Quiz Questions

Assignment-01 Links:
codeforces Invitation Link:
https://codeforces.com/contestInvitation/0933ec323333af14cd21eb66897327
53f301afff
Alternative Link: https://codeforces.com/contests/643746
[The alternative link will only work after you have successfully
registered using the first link.]
Deadline: Oct 26, 2025 2:00 PM
...
Judge platforms.
- Fast I/O Example: Python, C++, Java [click Expand to view
the code snippet]
...
Assignment-02 Links:
codeforces Invitation Link:
https://codeforces.com/contestInvitation/4b5bce1def150821d972352ed3b5c38e188e0538
Alternative Link: https://codeforces.com/contests/645582
[The alternative link will only work after you have successfully registered using the first link.]
Deadline: Nov 2, 2025 2:00 PM
No submission can be considered after the deadline ends.
